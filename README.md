...
- **Absent** — Absense, another bot built on Silicate. Several of Pathfinder's 2.alpha.2 improvements and the in-game assistant server came from reading his source; the code here is our own, the ideas are his.
