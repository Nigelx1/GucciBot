...
- **C0nscious** — the L* difficulty metric. The single number GucciBot puts on a macro's difficulty is his algorithm, from [Frame Window Counter](https://github.com/hyper-5/frame-window-counter) (MIT). Reached us via anticroom, who used it in his own analyzer.
