...
namespace ffmpeg {
    ...
    namespace events {
        namespace impl {
            ...
            using MixVideoAudio_t = geode::Result<> (*)(const std::filesystem::path&,
                                                        const std::filesystem::path&,
                                                        const std::filesystem::path&);
            using MixVideoRaw_t = geode::Result<> (*)(const std::filesystem::path&,
                                                      std::span<float>,
                                                      const std::filesystem::path&);
        ...
        public:
            ...
            static geode::Result<> mixVideoAudio(std::filesystem::path const& videoFile,
            ...
            static geode::Result<> mixVideoRaw(std::filesystem::path const& videoFile,
                                               std::span<float> raw,
                                               std::filesystem::path const& outputMp4File) {
                auto& vtable = impl::getVTable();
