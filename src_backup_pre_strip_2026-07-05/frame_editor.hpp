...
public:
    ...
    EditorFormat format = EditorFormat::BRR;
    ...
    BRRMacro* cachedBRR = nullptr;
    BRRMacro* cachedGDR = nullptr;

    void openBRR(const std::string& name, BRRMacro* macro);
    void openGDR(const std::string& name, BRRMacro* macro);
    void close();
    bool isActive() const;
