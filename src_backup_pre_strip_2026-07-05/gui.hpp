...
struct ThemeEngine {
    ImVec4 accentColor    = ImVec4(0.788f, 0.659f, 0.298f, 1.0f); // Gucci gold
...
private:
    ...
    void drawCreditsTab();
    void drawHudTab();      // v4.0: HUD labels
    void drawMoreHacksTab(); // v8.12: dedicated MegaHack-style hacks tab
